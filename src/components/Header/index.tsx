...
export function Header() {
  ...
  return (
    <header className="flex justify-between items-center w-full p-6 sticky top-0 z-50">
      <div className="flex flex-col sm:flex-row justify-between items-center w-full bg-gray-400/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-xl p-4 sm:py-5 sm:px-6">
